...
const messages = [
  ["Invalid definition id or payload", "Неверный код или данные определения"],
  ["Invalid definition", "Некорректное определение"],
  ["Definition not found", "Определение не найдено"],
  ["Invalid Tag relation", "Некорректное отношение тегов"],
  ["Tag relation not found", "Отношение тегов не найдено"],
  ["Invalid PRODUCT kind or inventory", "Некорректный вид продукта или инвентарь"],
  ["Invalid Formation health", "Некорректные хиты формирования"],
  ["Invalid inventory", "Некорректный инвентарь"],
  ["Invalid Unit composition", "Некорректный состав юнита"],
  ["Invalid Unit placement", "Некорректное размещение юнита"],
  ["Commander and combat PRODUCT kinds are required", "Требуются вид командира и боевые виды продуктов"],
  ["Formation or Unit not found", "Формирование или юнит не найдены"],
  ["Formation is already attached", "Формирование уже прикреплено"],
  ["Formation is not in source inventory", "Формирования нет в исходном инвентаре"],
  ["Formation transfer is invalid", "Некорректная передача формирования"],
  ["Cannot extract the last Formation", "Нельзя извлечь последнее формирование"],
  ["Artifact cannot be attached", "Артефакт нельзя прикрепить"],
  ["Artifact is not attached", "Артефакт не прикреплён"],
  ["Commander cannot be detached", "Командира нельзя открепить"],
  ["Replacement Commander is invalid", "Новый командир недопустим"],
  ["Current Commander is invalid", "Текущий командир некорректен"],
  ["Doctrine slots or Tag requirements not met", "Не хватает слотов доктрин или требуемых тегов"],
  ["Invalid Doctrine selection", "Некорректный выбор доктрин"],
  ["Invalid Unit name or morale", "Некорректное имя или мораль юнита"],
  ["Formation-derived health and combat power are read-only", "Хиты и боевая мощь, рассчитанные из формирований, доступны только для чтения"],
  ["Detection Tag codes (comma)", "Коды тегов обнаружения (через запятую)"],
  ["Create new Fleets and Armies in Unit Composition.", "Создавайте новые флоты и армии в разделе состава юнита."],
  ["INFANTRY", "ПЕХОТА"], ["full", "полные"],
  ["Morale loss per turn", "Потеря морали за ход"],
  ["Tags, Item Kinds and Doctrines", "Теги, виды предметов и доктрины"],
  ["Definitions are edited during Planning. Existing individual items keep their own stats.", "Определения меняются при планировании. Созданные предметы сохраняют свои характеристики."],
  ["Tag code", "Код тега"], ["Tag name", "Название тега"],
  ["Parent Tag codes (comma)", "Коды родительских тегов (через запятую)"],
  ["Save Tag", "Сохранить тег"], ["Tag A", "Тег А"], ["Tag B", "Тег Б"],
  ["Tag relation", "Отношение тегов"], ["Save Tag relation", "Сохранить отношение тегов"],
  ["ALLY", "СОЮЗНЫЙ"], ["NEUTRAL", "НЕЙТРАЛЬНЫЙ"], ["HOSTILE", "ВРАЖДЕБНЫЙ"],
  ["Item Kinds", "Виды предметов"], ["Kind code", "Код вида"], ["Type", "Тип"],
  ["Kind name", "Название вида"], ["Tag codes (comma)", "Коды тегов (через запятую)"],
  ["Configuration JSON", "Конфигурация JSON"],
  ["Base combat power", "Базовая боевая мощь"], ["Maximum health", "Максимальные хиты"],
  ["Commander capable", "Может быть командиром"], ["Effects JSON", "Эффекты JSON"],
  ["Save Item Kind", "Сохранить вид предмета"], ["Doctrines", "Доктрины"],
  ["Doctrine code", "Код доктрины"], ["Doctrine name", "Название доктрины"],
  ["Tag requirements JSON", "Требования по тегам JSON"], ["Save Doctrine", "Сохранить доктрину"],
  ["Unit Composition", "Состав юнита"], ["Unit", "Юнит"], ["Current health", "Текущие хиты"],
  ["Unit name", "Название юнита"], ["Save Unit", "Сохранить юнит"],
  ["Create complete Unit", "Создать готовый юнит"], ["Commander Kind", "Вид командира"],
  ["Formation Kind codes (comma)", "Коды видов формирований (через запятую)"],
  ["Create Unit", "Создать юнит"], ["Edit Unit", "Изменить юнит"],
  ["Create Formation in Unit inventory", "Создать формирование в инвентаре юнита"],
  ["Formation in Unit inventory", "Формирование в инвентаре юнита"],
  ["Attach Formation", "Прикрепить формирование"], ["Attached Formation", "Прикреплённое формирование"],
  ["Extract Formation to Unit inventory", "Извлечь формирование в инвентарь юнита"],
  ["Artifact in Unit inventory", "Артефакт в инвентаре юнита"],
  ["Attach Artifact", "Прикрепить артефакт"], ["Detach Artifact", "Открепить артефакт"],
  ["Replace Commander", "Сменить командира"],
  ["Assigned Doctrine codes (comma)", "Коды назначенных доктрин (через запятую)"],
  ["Assign Doctrines", "Назначить доктрины"],
  ...
  ["Attached Artifact cannot be transferred", "Прикреплённый артефакт нельзя передать"],
